      ...
      child: Scaffold(
        ...
        body: ListView(
          ...
          children: [
            ...
            // Employee Mobile entry point — relocated here after
            // AuthChoiceScreen (its original home) was removed along with
            // the Consumer email/password account layer. Deliberately
            // small and separate from every Consumer control above,
            // matching the original design's "never mixed into Consumer
            // sign in" intent.
            Center(
              child: TextButton(
                onPressed: () => context.push('/employee/login'),
                child: Text(
                  isAr ? 'موظف شركة؟ تسجيل الدخول ←' : 'Company Employee? Sign in →',
