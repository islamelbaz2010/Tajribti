...
// Mobile Recovery + Current-Backend Alignment (2026-09-15): current
// Campaign.status values are uppercase (DRAFT/READY/ACTIVE/PAUSED/
// COMPLETED — see api/prisma/schema.prisma) — the old lowercase keys here
// never matched and silently fell back to grey for every status.
