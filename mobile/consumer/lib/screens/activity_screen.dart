...
class _ActivityScreenState extends State<ActivityScreen> {
  ...
  Future<void> _load() async {
    ...
    try {
      // Mobile Recovery + Current-Backend Alignment (2026-09-15): no
      // consumer profile endpoint exists — participation history comes
      // directly from GET /consumer/participations.
      final records = await apiClient.getParticipations();
