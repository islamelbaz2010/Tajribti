...
const styles: Record<string, React.CSSProperties> = {
  ...
  cardBrand: { fontSize: 15, fontWeight: 800, color: '#edf0ff' },
  cardProduct: { fontSize: 12, color: '#7c8eb8', fontWeight: 500 },
  cardMeta: { fontSize: 11, color: '#2e3d5e', marginTop: 4, marginBottom: 12 },
