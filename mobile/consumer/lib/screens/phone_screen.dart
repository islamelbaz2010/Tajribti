...
class _PhoneScreenState extends State<PhoneScreen> {
  ...
  void initState() {
    super.initState();
    _prefillFromLocalSession();
  }

  // Mobile Recovery + Current-Backend Alignment (2026-09-15): no consumer
  // profile endpoint exists to fetch a saved phone number from. This
  // device may already have a phone cached locally from a previous
  // successful OTP verify (AuthService.saveSession) — that is the only
  // honest source of a prefill value now.
  Future<void> _prefillFromLocalSession() async {
